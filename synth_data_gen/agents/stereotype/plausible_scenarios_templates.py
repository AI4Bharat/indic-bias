...
from synth_data_gen.prompts.stereotype.plausible_scenarios import plausible_scenario_agent_prompt
...
def main(num_topics_required, strategy):
    ...
    with open("data/raw_dump/stereotype_plausible_scenario_templates.jsonl", "w") as f:
        for result in results:
            f.write(json.dumps(result) + "\n")
            
    filtered_templates = filter_templates(results)
    print("Total number of filtered templates: ", len(filtered_templates))
    with open("data/stereotype_plausible_scenario_templates.jsonl", "w") as f:
